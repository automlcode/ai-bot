...
declare global {
  ...
  const fromEvent: typeof import('@vueuse/rxjs')['fromEvent']
  ...
  const toObserver: typeof import('@vueuse/rxjs')['toObserver']
  ...
  const useObservable: typeof import('@vueuse/rxjs')['useObservable']
  ...
  const useSubject: typeof import('@vueuse/rxjs')['useSubject']
  const useSubscription: typeof import('@vueuse/rxjs')['useSubscription']
  ...
  const watchExtractedObservable: typeof import('@vueuse/rxjs')['watchExtractedObservable']
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly invoke: UnwrapRef<typeof import('@tauri-apps/api')['invoke']>
